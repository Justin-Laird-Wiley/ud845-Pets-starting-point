...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void savePet() {
        ...
        if (mCurrentPetUri == null) {
            ...
            if (newUri == null) {
                ...
                Toast.makeText(this, getString(R.string.editor_insert_pet_success), Toast.LENGTH_LONG).show();
            }
        } else {
            String[] selectionArgs = new String[]{String.valueOf(ContentUris.parseId(mCurrentPetUri))};

            int row = getContentResolver().update(mCurrentPetUri,
                    values,
            ...
            if (row == -1) {
                ...
                Toast.makeText(this, getString(R.string.editor_update_pet_success), Toast.LENGTH_LONG).show();
            }
        }
    }
    ...
    private void deletePet() {
        ...
        int rowDeleted = getContentResolver().delete(mCurrentPetUri,
                null, null);

        if (rowDeleted == 0) {
            Toast.makeText(this, "No pet deleted", Toast.LENGTH_LONG).show();
            ;
        } else {
